  ...
  return (
    <nav className="flex-between w-full mb-16 pt-3">
      ...
      <div className="sm:flex hidden">
        {isUserLoggedIn ? (
          <div className="flex gap-3 md:gap-5">
            ...
            <Link href="/profile">
              <Image src="/assets/images/logo.svg" alt="img" width={37} height={37} className="rounded-full" />
            </Link>
          </div>
        ) : (
          <>
      ...
      <div className="sm:hidden flex relative">
        {isUserLoggedIn ? (
          <div className="flex">
            <Image src="/assets/images/logo.svg" alt="img" width={37} height={37} className="rounded-full" onClick={() => setToggle((prev) => !prev)} />
            {toggle && (
